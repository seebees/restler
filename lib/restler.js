var util       = require('util'),
    ...
    Request = inherit(
        ...
        function (uri, options) {
            ...
            //Set internal defaults for this request
            ...
            if (self.options.query && !self.url.query) {
                switch (typeof self.options.query){
                    case 'object':
    ...
    Service = function (baseURL, defaults, ServiceRequest) {
        ...
        //defaults must have a rational value
        defaults = defaults || {};
     ...
     * 
     */
    customRequest = function (methods) {
        return inherit(Request, methods);
    };
